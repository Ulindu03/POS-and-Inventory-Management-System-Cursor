...
router.get('/barcode/generate', authenticate, authorize('admin', 'sales_rep'), ProductController.generateBarcode);
router.get('/barcode/:code', ProductController.getByBarcode);
router.get('/stats', authenticate, ProductController.getStats);
router.post('/images', authenticate, authorize('admin', 'sales_rep'), upload.single('image'), ProductController.uploadImage);
...
// Sticker batches
router.post('/stickers/batch', authenticate, authorize('admin', 'sales_rep'), ProductController.createStickerBatch);
router.get('/stickers/batch', authenticate, authorize('admin', 'sales_rep'), ProductController.getStickerBatch);
